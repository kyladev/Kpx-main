...
create_section(false, true, "Show Navbar in App View", "", "appnav-text", "sections-container", 0, "appview-navbar-section-items");
...
create_section(false, true, "Show Navbar in Tool View", "", "toolnav-text", "sections-container", 0, "toolview-navbar-section-items");
add_select_body(document.getElementById("toolview-navbar-section-items"), "toolview-navbar-select", "toolview-navbar-set");
add_select_option(document.getElementById("toolview-navbar-select"), "true", "Visible");
add_select_option(document.getElementById("toolview-navbar-select"), "false", "Hidden");
document.getElementById("toolview-navbar-set").addEventListener("click", function () {
    toggle_tool_nav();
});
